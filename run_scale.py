...
from codebase import utils as ut
from codebase.models.mask_vae_scale import CausalVAE
import argparse
from pprint import pprint
cuda = torch.cuda.is_available()
...
parser.add_argument('--toy',       type=str, default="scale_mask",     help="Flag for toy")
